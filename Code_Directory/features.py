...
class WordPosPos(Feature):
    ...
    def __call__(self, word, pos, other_pos):
        ...
        return other_pos_idx * len(self._word_pos_pairs_idx) + word_pos_idx, len(self._word_pos_pairs_idx) * len(
            self._pos_idx)
...
class PosPosPosPos(Feature):
    ...
    def __call__(self, pos1, pos2, pos3, pos4):
        ...
        return pos1_idx * (len(self._pos_idx) ** 3) + pos2_idx * (len(self._pos_idx) ** 2) + pos3_idx * len(
            self._pos_idx) + pos4_idx, len(self._pos_idx) ** 4
...
class BasicFeatures:
    ...
    def __call__(self, h, m, sentence):
        ...
        return [f_p_word_p_pos, f_p_word, f_p_pos, f_c_word_c_pos, f_c_word, f_c_pos, f_c_word_c_pos_p_pos,
                f_p_word_p_pos_c_pos, f_p_pos_c_pos]
...
class ComplexFeatures(BasicFeatures):
    ...
    def __call__(self, h, m, sentence):
        ...
        return basic_features + [p_pos_p_pos1_c_pos_1_c_pos, p_pos_1_p_pos_c_pos_1_c_pos,
                                 p_pos_p_pos1_c_pos_c_pos1, p_pos_1_p_pos_c_pos_c_pos1, p_c_dist,
                                 p_c_direction] + self._f_between_pos(h, m, sentence)
